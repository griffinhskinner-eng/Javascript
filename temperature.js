...
function convertTemperature() {
    ...
    if (fromUnit.value === "C" && toUnit.value === "C") {
        ...
        result.textContent = temperature + 273.15 + "°K";
    }
        ...
        result.textContent = (temperature - 32) * 5 / 9 + 273.15 + "°K";
    }

    else if (fromUnit.value === "K" && toUnit.value === "C") {
        result.textContent = temperature - 273.15 + "°C";
    }

    else if (fromUnit.value === "K" && toUnit.value === "F") {
        result.textContent = (temperature - 273.15) * 9 / 5 + 32 + "°F";
    }
